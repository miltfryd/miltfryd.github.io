    ...
    for (let element of data) {
        ...
        for (const key in element) {
            ...
            if(countcolumn==6){
                ...
                //first row of the ARRAY in "Δεδομένα των sets"
...
let table3 = document.getElementById('tablestats'); //same as the var "table" at the top!
//THESE TWO ARE NOT NECESSARY IN THE THIRD HOMEWORK.
...
const checkRegister = () => {
    ...
    document.getElementById("initplaystyle").value === "") {
        ...
        document.getElementById("checkname").innerHTML = "*Please fill all the blanks!";
    }else{
        saveToLocalStorage();
...
//His/Her birth year
const birthyear = parseInt(document.getElementById("infobyear").innerHTML);
//His/Her age
...
//Find out how many wins and losses he has based on the match-stats (Singles) array.
